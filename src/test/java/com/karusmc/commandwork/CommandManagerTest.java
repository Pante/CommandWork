...
import com.karusmc.commandwork.mockobjects.*;
...
public class CommandManagerTest {
    ...
    private CommandDispatcher dispatcher = mock(CommandDispatcher.class);
    ...
    public void register_PutsCommandInMap_Calls_CommandDispatcher_register() {
        ...
        verify(dispatcher, times(1)).register(command);
    }
    ...
    public void unregister_RemoveCommandFromMap_Calls_CommandDispatcher_unregister() {
        ...
        verify(dispatcher, times(1)).unregister(command);
    }
